...
constexpr const char* INDEX_IVF_TURBOQUANT = "IVF_TURBOQUANT";
constexpr const char* INDEX_IVF_TQMSE = "IVF_TQMSE";
...
constexpr const char* INDEX_HNSW_TQMSE = "HNSW_TQMSE";
