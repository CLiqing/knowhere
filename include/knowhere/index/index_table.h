...
static std::set<std::pair<std::string, VecType>> legal_knowhere_index = {
    ...
    {IndexEnum::INDEX_IVF_TURBOQUANT, VecType::VECTOR_FLOAT},
    {IndexEnum::INDEX_IVF_TURBOQUANT, VecType::VECTOR_FLOAT16},
    {IndexEnum::INDEX_IVF_TURBOQUANT, VecType::VECTOR_BFLOAT16},
    {IndexEnum::INDEX_IVF_TQMSE, VecType::VECTOR_FLOAT},
    {IndexEnum::INDEX_IVF_TQMSE, VecType::VECTOR_FLOAT16},
    {IndexEnum::INDEX_IVF_TQMSE, VecType::VECTOR_BFLOAT16},
    ...
    {IndexEnum::INDEX_HNSW_TURBOQUANT, VecType::VECTOR_FLOAT},
    {IndexEnum::INDEX_HNSW_TURBOQUANT, VecType::VECTOR_FLOAT16},
    {IndexEnum::INDEX_HNSW_TURBOQUANT, VecType::VECTOR_BFLOAT16},

    {IndexEnum::INDEX_HNSW_TQMSE, VecType::VECTOR_FLOAT},
    {IndexEnum::INDEX_HNSW_TQMSE, VecType::VECTOR_FLOAT16},
    {IndexEnum::INDEX_HNSW_TQMSE, VecType::VECTOR_BFLOAT16},
