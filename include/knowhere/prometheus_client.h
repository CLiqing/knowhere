...
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_filter_prepare_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_filter_cache_hit_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_distance_attempt_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_scan_all_query_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_scan_filter_query_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_scan_by_valid_ids_query_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_dense_per_query_scan_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_roaring_per_query_scan_cnt, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_filter_prepare_latency, PROMETHEUS_LABEL_CARDINAL);
KNOWHERE_DECLARE_PROMETHEUS_HISTOGRAM(bf_search_latency, PROMETHEUS_LABEL_CARDINAL);
